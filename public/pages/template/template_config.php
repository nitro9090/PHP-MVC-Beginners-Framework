<?php
     ...
     $current_page->requiresAuthentication = false;  //does this page require authentication for access (not implemented)
     $current_page->use_googleAnalytics = false; //should this page be tracked by google analytics (not implemented)
